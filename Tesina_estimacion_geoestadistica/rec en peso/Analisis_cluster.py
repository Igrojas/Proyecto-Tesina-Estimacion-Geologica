...
def guardar_resultados_cluster(
    df: pd.DataFrame,
    metodo: str,
    output_dir: str = '../data/processed/cluster/recpe',
) -> str:
    """
    ...
    nombre = f'clusters_recpe_{metodo}_{fecha_hora}.xlsx'
    ruta = os.path.join(output_dir, nombre)
    try:
        df.to_excel(ruta, index=False)
    except Exception:
        ruta = os.path.join(output_dir, f'clusters_recpe_{metodo}_{fecha_hora}.csv')
...
def run_analisis_completo(
    ruta_datos: str = '../data/processed/df_recpe.xlsx',
    n_clusters_kmeans: int = 3,
    dbscan_eps: float = 0.5,
    dbscan_min_samples: int = 5,
    variable_ley: str = 'recpe',
    variable_nscore: str = 'recpe_nscore',
...
if __name__ == '__main__' or True:
    df_kmeans, df_dbscan = run_analisis_completo(
        ruta_datos='../data/processed/df_recpe.xlsx',
        n_clusters_kmeans=3,
        dbscan_eps=1,
        dbscan_min_samples=30,
        variable_ley='recpe',
        variable_nscore='recpe_nscore',
